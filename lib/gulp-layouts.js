  ...
  datasets.index = [
    {
      ...
      filename: 'index.html',
      basePath: '.',
      title: defaultData.content.metaTitle || defaultData.content.title,
      twitterTitle:
        defaultData.content.metaTitle || defaultData.content.twitterShare,
      facebookTitle:
        defaultData.content.facebookTitle ||
        defaultData.content.metaTitle ||
        defaultData.content.twitterShare,
